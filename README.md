...
```
=======
# Identity-Stable-Multi-Object-Tracking-with-YOLO11m-McByte-SAM-Cutie
An experimental multi-object person tracking pipeline using YOLO11m, McByte, SAM, and Cutie. Designed to improve identity consistency during occlusion, overlap, and crossing scenarios using appearance-based matching, spatial continuity, lost-track recovery, and new-ID suppression. Built for testing, experimentation, and research.

# Identity-Stable Multi-Object Tracking with YOLO11m, McByte & SAM/Cutie

An experimental computer vision pipeline for multi-person tracking in videos using **YOLO11m**, **McByte**, **SAM**, and **Cutie**.

The project focuses on maintaining consistent person identities during **occlusion, overlapping, crossing, and temporary disappearance** while providing segmentation masks for tracked objects.

---

## 🚀 Project Overview

Multi-object tracking systems can experience **ID switches** when people overlap, become temporarily occluded, or disappear and reappear.

This project combines:

- **YOLO11m** for person detection
- **McByte** for multi-object tracking
- **Appearance-based matching** for identity consistency
- **Spatial/center continuity** for motion consistency
- **Lost-track recovery** for temporarily occluded persons
- **New-ID suppression** to reduce unnecessary ID creation
- **SAM/Cutie** for object segmentation and mask propagation

The goal is to improve identity consistency while tracking multiple people throughout a video.

---

## ✨ Features

-  YOLO11m-based person detection
-  Multi-object person tracking
-  Persistent tracking IDs
-  Appearance-based identity matching
-  Spatial continuity checking
-  Lost-track recovery
-  New-ID suppression near recently lost tracks
-  Segmentation masks using SAM/Cutie
...
```text
             ...
             ┌───────────┴───────────┐
             ▼                       ▼
    Appearance Matching       Spatial Matching
             │                       │
             └───────────┬───────────┘
                         ▼
             ...
             ┌───────────┴───────────┐
             ▼                       ▼
       Lost Track Recovery     New ID Suppression
             │                       │
             └───────────┬───────────┘
                         ▼
                  SAM / Cutie
...
└── output/
    └── README.md
>>>>>>> 49d35b9b6730482795c3c3c03a2e8ff146a7a36a
